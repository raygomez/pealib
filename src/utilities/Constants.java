...
public class Constants {
	...
	public static final int FIRST_NAME_FORMAT_ERROR = 3;
	public static final int LAST_NAME_FORMAT_ERROR = 4;
	public static final int CONTACT_NUMBER_FORMAT_ERROR = 5;
	public static final int EMAIL_FORMAT_ERROR = 6;
